...
public abstract class ShootableObjectCtrl : SaiMonoBehaviour
{
    ...
    public DamageReciever DamageReciever => damageReciever;
    ...
    {
        if (this.damageReciever != null) return;
        this.damageReciever = transform.GetComponentInChildren<DamageReciever>();
        Debug.LogWarning(transform.name + ": LoadDamageReciever", gameObject);
    }
